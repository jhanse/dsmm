...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('is_commentable', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        ...
        db.create_table('blog_page', (
            ...
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('published', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('sidebar_title', self.gf('django.db.models.fields.CharField')(default=None, max_length=30, blank=True)),
            ('sidebar', self.gf('django.db.models.fields.TextField')(default=None, blank=True)),
        ))
